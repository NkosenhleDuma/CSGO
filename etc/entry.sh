...
${STEAMAPPDIR}/srcds_run -game csgo -console -autoupdate -steam_dir ${STEAMCMDDIR} -steamcmd_script ${STEAMAPPDIR}/csgo_update.txt -usercon -tickrate $SRCDS_TICKRATE -port $SRCDS_PORT +game_mode $SRCDS_GAMEMODE +mapgroup $SRCDS_MAPGROUP +map de_cache +sv_setsteamaccount 75746D037C8EC44DC1E4224C4228E970 +sv_lan 1